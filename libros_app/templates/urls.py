...
path('peliculas/', MovieList.as_view(), name="peliculas"),
    ...
    path('peliculas_actualizar/<int:pk>/',
         MovieUpdate.as_view(), name="peliculas-actualizar"),
    path('peliculas_eliminar/<int:pk>/',
         MovieDelete.as_view(), name="peliculas-eliminar"),
